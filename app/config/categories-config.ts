export const categoriesData = [
  ...
  current with trends and happening in the global crypto space, and the world of web3/blockchain engineering.`,
    ...
    categoryId: 'blog',
    categoryType: 'platform-content',
    categoryDomain: 'platform'
  },
  {
  ...
  {
    categoryName: 'Learn Solana Development',
  ...
  you master everything you need to know about web3 engineering with Foundry. Suitable for all categories of web3 professional - beginners
   mid-level folks and 'veterans' alike.`,
    categoryRoute: '/posts/solana',
    categoryId: 'foundry',
    categoryType: 'learn-content',
    categoryDomain: 'solana'
  },
  {
  ...
  {
    categoryName: 'Learn Solana Anchor',
    categoryBrief: `A comprehensive tutorial series for learning smart contract development with Anchor - Solana's Sealevel 
    run-time framework. Dive in to explore top quality content to help level up your smart contract development on the Solana network`,
    categoryRoute: '/posts/anchor',
    categoryId: 'foundry',
    categoryType: 'learn-content',
    categoryDomain: 'solana'
  },
  {
    categoryName: 'The Web3 Mastery WSL Handbook',
    categoryBrief: `A comprehensive and simplified tutorial series for configuring and working with WSL(Windows Sub-system for Linux)
    on the Windows operating system.`,
    categoryRoute: '/posts/wsl',
    categoryId: 'wsl',
    categoryType: 'learn-content',
    categoryDomain: 'platform'
  }
