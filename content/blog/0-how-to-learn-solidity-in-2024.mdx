...
He loves building and scaling startups, and is currently a Senior/Lead Developer at Terabyte. He is also the founder
...
write your test(s) and script(s), e.g. your deployment script(s), or scripts to interract with functionalities provided in 
the smart contact.
...
differently, types and return-types, visibility, and storage - all in solidity, and more other differences. 
...
take out some time and learn Typescript before proceding to learn Solidity. One to three(1 - 3) weeks of hardwork should be more than 
enough for that.
...
![screenshot of the 'Learn Blockchain, Solidity, and Full Stack Web3 Development with JavaScript
 ...
 also by [Patrick Collins](https://twitter.com/PatrickAlphaC).
