...
> Also note carefully, that the roadmap and all the technologies mentioned in this article are not all there 
is to working as a blockchain developer(with Solidity on Ethereum). The blockchain engineering world is way bigger, with 
the expansion still carrying on.
...
> 3. Learn about the ERC-1155 token standard. 
...
> One last important point I wish to re-emphasize, is that - the roadmap and all the technologies mentioned in this article are 
not all that there is to working as a blockchain developer(with Solidity on Ethereum). There is still a lot that was not 
covered or discussed in this article. Simply put, that becoming exceptional at all the technologies that were listed here, 
will be enough to make you a highly sought-after web3 engineer.
