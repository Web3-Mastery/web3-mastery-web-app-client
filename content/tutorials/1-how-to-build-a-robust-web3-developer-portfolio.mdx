...
The engineering scope of the portfolio intended in this article, is **"full-stack"** + more. This means that you'd require front-end 
development, back-end development, and smart contract development knowledge - using Etherum(with Solidity) as the 
prefered blockchain network. A knowledge of cloud and DevOps will also be highly relevant.
...
This articles seeks to offer a complete guide to anyone who wishes to know how to build a web3 developer portfolio 
...
<mark>Knowing them simply gives you the super powers)to become an irresistibly web3/blockchain engineer</mark> .
...
![screenshot of the 'Learn Blockchain, Solidity, and Full Stack Web3 Development with JavaScript
 – 32-Hour Course' youtube page](/post-image_03.png)
...
![a screenshot from the remix IDE website/web app](/post-image_14.png)
...
> 2. Build a simple P2P(pair-to-pair) web or mobile app with which users can send and recieve cryto to/from any external address, or to/from 
...
Your choice should be one of either Hardhat or Foundry.
...
![a screenshot from the foundry website](/post-image_16.png)
...
decentralized on-chain/off-chain and cross-chain interractions, Filecoin and/or IPFS (it'll be better to stick with IPFS for now) for 
decentralized file storage, and maybe Fleek, for hosting static-only website - so as to enable you build "fully decentraized" projects.
...
Those three, should do for now. You might need to one or more later.
...
Finally, you should learn more robust tools like [Moralis](https://moralis.io/), and/or [Wagmi](https://wagmi.sh/) - for better/more 
robust interactions with your smart contracts on the front-end.

![a screenshot from the 'The Graph' website](/post-image_15.png)
...
> OpenZepellin is a platform that helps developers build smart contracts faster. By hooking into their provided 
libraries(their ERC-20 token library/libraries in this case), you can easily build an ERC-20 token in a matter of minutes.

![a screenshot from the OpenZeppelin website](/post-image_17.png)

> Recommended project(s):
>
> 1. After folowing up to this point, you should have built and deployed two ERC-20 tokens. Which should be enough.
>
> You can however proceed to learn more about the uses of ERC-20 token(e.g for governance), and create a more realistic one to 
...
![a screenshot from the Uniswap website](/post-image_18.png)
...
>
> After finishing this project, you can then choose to proceed with building your own Defi platform from scratch - if you wish.
...
> Recommended project(s):
>
> 1. At this point, you should have built, deployed, and minted NFTs from two ERC-721 token smart contracts. That should do for the 
token part. Simple integrate the smart contracts to beautiful UIs(user interfaces), to enable NFT minting without direct interraction 
with the smart contracts.
> 2. Build a decentralized NFT marketplace where users can sell/buy, and swap NFTs(NFT for NFT, and NFT for crypto or fiat)

## 6. Working with upgrade-able smart contracts

Indeed, smart contracts can be upgraded. More details on that will come in another article.

Your mission here is to learn and master all you can about upgrade-able smart contracts, build and practice making some to become upgradeable, 
and ensure to be as job ready as possible - with regards to working with upgrade-able contracts.

> Recommended project(s):
>
> 1. Practice improving as many of the smart contract you've previously built to become upgradeable.
...
## 8. A solid knowledge of some **very very important** blockchain practices(security and gas optimization).

The highly sensitive nature of blockchains(in smart contracts) makes it very important that high security measure are taken to
...
invest thousands(maybe even millions) of dollars to have their smart contracts audited in search for vulnerabilities.
...
With respect to web3 security, I deeply wish to applaud the works of [Patrick Collins](https://twitter.com/PatrickAlphaC) and 
the awesome team at [Cyfrin](https://www.cyfrin.io/) for all their efforts towards ensuring improved security in the 
global web3 space. All their labours are priceless.

![a screenshot from the Cyfrin website](/post-image_19.png)
...
![a screenshot from the Huff website](/post-image_20.png)
...
I trust that this article will serve as a very helpful guide to the many aspiring blockchain developers out there.
