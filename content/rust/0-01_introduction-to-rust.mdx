---
postTitle: '01: Introduction To Rust'
postDate: 'May 6, 2024'
postIndex: 0
...
postSlug: "01_introduction-to-rust"
...
Rust is both statically typed, and strongly typed. This means, it insists that the data type for every variable must be known at compile 
time(static typing), and enforces restrictions on converting between data types(strong typing).
...
low-level control - a relieving features that other "complex" low-level programming languages have long been unable to provide. 
...
To make the best out of this tutorial series, it is expected that you at least have some previous programming experience, with 
**basic understanding** of different programming concepts like variables, functions, data-types, and more. It'll be even more perfect
if you know [Typescript](https://www.typescriptlang.org) or if you have previous experience with a fully(strongly and statically) typed programming language.


> It is very possible to follow through even if you're a total newbie/beginner. But following this series will be a lot more favourable if you
already have previous programming experience with at least one programming language.
>
>Eitherway, you do not need to have any previous experience working with Rust.

This series(thanks to a professionally crafted curriculum) will cover all the relevant aspects that you'll need to 
become very comfortable with buiding systems in Rust. The series will wrap up with introducing you to building web3 related projects
with Rust.

The series will also follow through(in a thorough fashion) with solid and relevant examples/projects to help you learn and 
master every shared concept as perfectly as possible.
...
and top-notch project-based web3 tutorials that are thorough and complete enough to help you build a robust 
